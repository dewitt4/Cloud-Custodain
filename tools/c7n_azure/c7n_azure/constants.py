...
ENV_CONTAINER_EVENT_QUEUE_ID = 'AZURE_CONTAINER_STORAGE_RESOURCE_ID'
ENV_CONTAINER_EVENT_QUEUE_NAME = 'AZURE_CONTAINER_QUEUE_NAME'
ENV_CONTAINER_POLICY_STORAGE = 'AZURE_CONTAINER_POLICY_URI'
